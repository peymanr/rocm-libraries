...
// Engine plugin C ABI 1.1.0: the rocKE client implements the full 1.1 surface,
// including the optional override-shape execute entry point exported in
// PluginPublic.cpp (which declines, since override shapes are not served yet).
#define HIPDNN_PLUGIN_API_VERSION "1.1.0"
