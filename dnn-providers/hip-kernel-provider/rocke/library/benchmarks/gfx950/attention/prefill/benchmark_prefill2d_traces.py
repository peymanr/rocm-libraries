...
Example:
    ...
    PYTHONPATH=python python \\
      rocke/library/benchmarks/gfx950/attention/prefill/benchmark_prefill2d_traces.py
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "rocke/library/benchmarks/gfx950/attention/prefill/prefill2d_bf16_triton_ckdsl_perf.csv"
        ),
