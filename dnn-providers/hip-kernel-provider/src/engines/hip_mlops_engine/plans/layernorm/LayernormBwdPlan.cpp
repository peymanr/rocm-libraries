                               ...
                               const hipDeviceProp_t& deviceProperties)
{
    ...
    if(_isParallel)
    {
        ...
        _runnableKernels.push_back(_compiledProgram->getKernel("LayernormBwdWeightBiasParallel"));
        ...
        _runnableKernels.push_back(_compiledProgram->getKernel("LayernormBwdWeightBiasReduceSum"));
    ...
    else
    {
        ...
        _runnableKernels.push_back(_compiledProgram->getKernel("LayernormBwdWeightBias"));
        _runnableKernels[1]->setBlockSize(static_cast<unsigned int>(_localSize),
                                          static_cast<unsigned int>(1),
                                          static_cast<unsigned int>(1));
