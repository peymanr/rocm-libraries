...
*************************************
Build and install hipSPARSE for Linux
*************************************

For information on installing and building hipSPARSE on Microsoft Windows, see :doc:`hipSPARSE for Windows <./build-windows>`.
