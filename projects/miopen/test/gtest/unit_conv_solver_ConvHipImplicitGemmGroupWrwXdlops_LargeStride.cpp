...
// element-strides exceeding INT_MAX (ROCM-23997). See
...
// Large_Tensor grouped WRW instance (MIOPEN_CK_LARGE_TENSOR_BWD_WRW==0), so
// this solver is expected to report inapplicable/skip for this shape until CK
// is rebuilt with ROCm/rocm-libraries PR #7734. The test is kept so it starts
// passing automatically once that lands.
//
